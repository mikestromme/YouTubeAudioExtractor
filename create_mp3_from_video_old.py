...
if __name__ == '__main__':
    ...
    #nput = getMP3('https://youtu.be/PjjNvjURS-s?si=7ypaDD90NpkOfI1r','downloads') # rush song - has odd character in title
    #input = getMP3('https://youtu.be/_FrOQC-zEog?si=roQ0jfWPVkFjRrsV','downloads') # this works
